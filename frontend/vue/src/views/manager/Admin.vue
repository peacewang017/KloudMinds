<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the username to query" style="width: 250px" v-model="username"></el-input>
    ...
    <el-dialog title="Manager" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="profile">
          ...
          >
            <el-button type="primary">Upload profile picture</el-button>
          </el-upload>
        </el-form-item>
      </el-form>
