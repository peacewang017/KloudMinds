  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="time" label="Delete time"></el-table-column>
        <el-table-column prop="userId" label="OperatorID"></el-table-column>
        <el-table-column prop="userName" label="Operator"></el-table-column>
