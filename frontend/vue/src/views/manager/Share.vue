<template>
  <div>
    <div class="search">
      ...
      <el-button type="warning" plain style="margin-left: 10px" @click="reset">resetting</el-button>
    </div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="endTime" label="Expiration date"></el-table-column>
        <el-table-column prop="count" label="Visited"></el-table-column>
        <el-table-column prop="userId" label="Sharer ID"></el-table-column>
        <el-table-column prop="userName" label="Sharer"></el-table-column>
        <el-table-column prop="code" label="Identifying code"></el-table-column>
...
export default {
  ...
  methods: {
    del(id) {   // 单个删除
      this.$confirm('Are you sure to delete this file in bulk?', 'Confirm to delete', {type: "warning",confirmButtonText: 'Confirm',cancelButtonText: 'Cancel'}).then(response => {
